...
const BUBBLES = [
  // Companies
  { label: "Apolis", color: "#6ED7FF", radius: 38 },
  { label: "Valory", color: "#FF7C5E", radius: 35 },
  { label: "Pibit", color: "#FFD56A", radius: 32 },
  { label: "LG", color: "#A50034", radius: 28 },
  { label: "Smarter", color: "#7CE38B", radius: 34 },
  { label: "OpenAI", color: "#10A37F", radius: 36 },
  { label: "Claude", color: "#D4A574", radius: 33 },
  // Frameworks & Tools
  { label: "LangChain", color: "#1C3C3C", radius: 40 },
  { label: "FastAPI", color: "#009688", radius: 30 },
  { label: "Python", color: "#3776AB", radius: 42 },
  { label: "Elastic\nsearch", color: "#FED10A", radius: 41 },
  { label: "Qdrant", color: "#DC382C", radius: 29 },
  { label: "Docker", color: "#2496ED", radius: 32 },
  { label: "AWS", color: "#FF9900", radius: 30 },
  { label: "Redis", color: "#DC382C", radius: 28 },
  { label: "Hugging\nFace", color: "#FFD21E", radius: 36 },
  { label: "vLLM", color: "#8B7BFF", radius: 26 },
  { label: "Kubernetes", color: "#326CE5", radius: 38 },
  { label: "PostgreSQL", color: "#336791", radius: 35 },
  // Concepts & Skills
  { label: "RAG", color: "#FF96D5", radius: 29 },
  { label: "Agents", color: "#A78BFA", radius: 40 },
  { label: "LLM", color: "#F472B6", radius: 34 },
  { label: "DeFi", color: "#98FFEA", radius: 28 },
  { label: "On-Chain", color: "#34D399", radius: 32 },
  { label: "TypeScript", color: "#3178C6", radius: 36 },
  { label: "DevOps", color: "#6F86FF", radius: 26 },
  { label: "Celery", color: "#A9CC54", radius: 25 },
  { label: "RLHF", color: "#F97316", radius: 28 },
  { label: "React", color: "#61DAFB", radius: 30 },
  { label: "Next.js", color: "#FFFFFF", radius: 29 },
];
